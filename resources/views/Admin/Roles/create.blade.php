...
@csrf
    ...
    <div class="layui-input-inline">
      <input type="text" required="required" name="name"  maxlength="20"  autocomplete="off" lay-verify="required" placeholder="请输入名称" class="layui-input">
    </div>
    <div class="layui-form-mid layui-word-aux layui-icon layui-icon-tips"> 角色的名称</div>
  </div>

  	 <div class="layui-form-item">
    <label class="layui-form-label"><span class="x-red">*</span>描述</label>
    <div class="layui-input-block">
      <input type="text" required="required" name="account" lay-verify="required" maxlength="50"  autocomplete="off" placeholder="请输入描述" class="layui-input">
    </div>
  </div>
