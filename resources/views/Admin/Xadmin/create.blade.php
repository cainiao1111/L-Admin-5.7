...
<div class="layui-form-item"   >
 ...
 <div class="layui-form-item" pane="" >
    ...
    <div class="layui-input-block">
		<input type="checkbox" name="none" @if( old('none') ) checked="" @endif value="1" lay-skin="switch"  lay-text="是|否">
    </div>
  </div>
...
<div class="layui-form-item"  pane="" >
    ...
    <div class="layui-input-block">
		<input type="checkbox" name="super_model"  @if( old('super_model') ) checked="" @endif  value="1" lay-skin="switch"  lay-text="是|否">
    </div>
  </div>
