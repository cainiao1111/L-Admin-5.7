...
@csrf
    ...
    <div class="layui-input-inline">
      <input type="text" required="required" name="order_by" value="0"  maxlength="4"  autocomplete="off" lay-verify="required|number" placeholder="请输入名称" class="layui-input">
    </div>
...
<div class="layui-upload">
  ...
  <p type="button" class="layui-btn  layui-icon layui-icon-picture-fine layui-btn-normal" onclick="x_admin_show('历史图片-多图','{{url('picture.history.1.location')}}')" > 历史图片-多图</p>
...
<!---->
<blockquote class="layui-elem-quote">Demo多图-演示</blockquote>
<div id="location"></div>
