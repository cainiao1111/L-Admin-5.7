...
<div class="layui-upload">
  ...
  <div class="layui-upload-list">
    <img src="{{$b['r']->img}}" alt="" id="imageshow" class="view_image location" />
     <input type="hidden"  name="img" id="imagevalue" value="{{$b['r']->img}}"  autocomplete="off" lay-verify="imagevalue"  class="layui-input location">
 ...
 //duotu
  ...
  var uploadInst = upload.render({
    ...
    ,error: function(){
         layer.closeAll('loading'); 
      return layer.msg('上传失败!');
    },accept:'image',acceptMime: 'image/*',multiple:true,size:{{$b['size']}}
  });
