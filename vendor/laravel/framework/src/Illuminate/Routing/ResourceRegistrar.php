...
class ResourceRegistrar
{
    ...
    {
        $uri = $this->getResourceUri($name).'_create';
    ...
    {
        $uri = $this->getResourceUri($name).'_show_{'.$base.'}';
    ...
    protected function addResourceEdit($name, $base, $controller, $options)
    {
        ...
        $uri = $this->getResourceUri($name).'_edit_{'.$base.'}';
    ...
    {
        $uri = $this->getResourceUri('delete_api/'.$name).'_{'.$base.'}';
